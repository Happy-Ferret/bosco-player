...
define("tabs/NotebookTab", ["require", "exports"], function (require, exports) {
    "use strict";
    // Generated by CoffeeScript 1.11.1
    var GObject, Gtk, NotebookTab, Pango, slice = [].slice;
    GObject = imports.gi.GObject;
    Gtk = imports.gi.Gtk;
    Pango = imports.gi.Pango;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = NotebookTab = (function () {
        /*
...
define("tabs/PackageTab", ["require", "exports", "tabs/NotebookTab"], function (require, exports, NotebookTab_2) {
    "use strict";
    // Generated by CoffeeScript 1.11.1
    var GObject, Gtk, PackageTab, Pango, extend = function (child, parent) { for (var key in parent) {
        if (hasProp.call(parent, key))
            child[key] = parent[key];
    } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }, hasProp = {}.hasOwnProperty;
    GObject = imports.gi.GObject;
    ...
    Pango = imports.gi.Pango;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = PackageTab = (function (superClass) {
...
define("tabs/AutovalaTab", ["require", "exports", "tabs/NotebookTab"], function (require, exports, NotebookTab_4) {
    "use strict";
    // Generated by CoffeeScript 1.11.1
    var AutovalaTab, GObject, Gtk, Pango, extend = function (child, parent) { for (var key in parent) {
        if (hasProp.call(parent, key))
            child[key] = parent[key];
    } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }, hasProp = {}.hasOwnProperty;
    GObject = imports.gi.GObject;
    ...
    Pango = imports.gi.Pango;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = AutovalaTab = (function (superClass) {
...
define("Player", ["require", "exports", "Util", "Application"], function (require, exports, Util_2, Application_1) {
    ...
    Gtk = imports.gi.Gtk;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = Player = (function () {
        function Player() {
