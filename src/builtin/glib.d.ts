...
declare module "GLib" {
  ...
  export function assertion_message_error(domain: string, file: string, line: number, func: string, expr: string, error: Error, error_domain: any, error_code: number):void
  ...
  export function child_watch_add(pid: any, func: any, data: any):number
  export function child_watch_add_full(priority: number, pid: any, func: any, data: any, notify: any):number
  ...
  export function file_get_contents(filename: string, contents: number[], length: number):boolean
  export function file_open_tmp(tmpl: string, name_used: string):number
  ...
  export function filename_from_uri(uri: string, hostname: string):string
  ...
  export function idle_add(func: any, data: any):number
  export function idle_add_full(priority: number, func: any, data: any, notify: any):number
  ...
  export function set_error(err: Error, domain: any, code: number, format: string, ...args: any[]):void
  export function set_error_literal(err: Error, domain: any, code: number, message: string):void
  ...
  export function timeout_add(interval: number, func: any, data: any):number
  export function timeout_add_full(priority: number, interval: number, func: any, data: any, notify: any):number
  export function timeout_add_seconds(interval: number, func: any, data: any):number
  export function timeout_add_seconds_full(priority: number, interval: number, func: any, data: any, notify: any):number
  ...
  export function unix_fd_add(fd: number, condition: IOCondition, func: any, user_data: any):number
  export function unix_fd_add_full(priority: number, fd: number, condition: IOCondition, func: any, user_data: any, notify: any):number
