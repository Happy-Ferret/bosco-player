...
declare module "GLib" {
  ...
  export function atomic_pointer_get(atomic: object):object
  ...
  export function child_watch_add(pid: Pid, function_: ChildWatchFunc, data: object):number
  export function child_watch_add_full(priority: number, pid: Pid, function_: ChildWatchFunc, data: object, notify: DestroyNotify):number
  ...
  export function datalist_foreach(datalist: Data, func: DataForeachFunc, user_data: object):void
  export function datalist_get_data(datalist: Data, key: string):object
  export function datalist_get_flags(datalist: Data):number
  export function datalist_id_dup_data(datalist: Data, key_id: Quark, dup_func: DuplicateFunc, user_data: object):object
  ...
  export function datalist_id_replace_data(datalist: Data, key_id: Quark, oldval: object, newval: object, destroy: DestroyNotify, old_destroy: DestroyNotify):boolean
  export function datalist_id_set_data_full(datalist: Data, key_id: Quark, data: object, destroy_func: DestroyNotify):void
  ...
  export function dataset_foreach(dataset_location: object, func: DataForeachFunc, user_data: object):void
  export function dataset_id_get_data(dataset_location: object, key_id: Quark):object
  export function dataset_id_remove_no_notify(dataset_location: object, key_id: Quark):object
  ...
  export function direct_equal(v1: object, v2: object):boolean
  export function direct_hash(v: object):number
  ...
  export function free(mem: object):void
  ...
  export function hash_table_add(hash_table: GLib.HashTable, key: object):boolean
  export function hash_table_contains(hash_table: GLib.HashTable, key: object):boolean
  export function hash_table_destroy(hash_table: GLib.HashTable):void
  export function hash_table_insert(hash_table: GLib.HashTable, key: object, value: object):boolean
  export function hash_table_lookup_extended(hash_table: GLib.HashTable, lookup_key: object, orig_key: object, value: object):boolean
  export function hash_table_remove(hash_table: GLib.HashTable, key: object):boolean
  export function hash_table_remove_all(hash_table: GLib.HashTable):void
  export function hash_table_replace(hash_table: GLib.HashTable, key: object, value: object):boolean
  export function hash_table_size(hash_table: GLib.HashTable):number
  export function hash_table_steal(hash_table: GLib.HashTable, key: object):boolean
  ...
  export function idle_add(function_: SourceFunc, data: object):number
  export function idle_add_full(priority: number, function_: SourceFunc, data: object, notify: DestroyNotify):number
  ...
  export function io_add_watch(channel: IOChannel, condition: IOCondition, func: IOFunc, user_data: object):number
  ...
  export function log_set_default_handler(log_func: LogFunc, user_data: object):LogFunc
  export function log_set_fatal_mask(log_domain: string, fatal_mask: LogLevelFlags):LogLevelFlags
  export function log_set_handler(log_domain: string, log_levels: LogLevelFlags, log_func: LogFunc, user_data: object):number
  export function log_set_handler_full(log_domain: string, log_levels: LogLevelFlags, log_func: LogFunc, user_data: object, destroy: DestroyNotify):number
  ...
  export function memdup(mem: object, byte_size: number):object
  ...
  export function qsort_with_data(pbase: object, total_elems: number, size: number, compare_func: CompareDataFunc, user_data: object):void
  ...
  export function realloc(mem: object, n_bytes: number):object
  export function realloc_n(mem: object, n_blocks: number, n_block_bytes: number):object
  ...
  export function slice_copy(block_size: number, mem_block: object):object
  ...
  export function spawn_async(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: SpawnChildSetupFunc, user_data: object, child_pid: Pid):boolean
  export function spawn_async_with_pipes(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: SpawnChildSetupFunc, user_data: object, child_pid: Pid, standard_input: number, standard_output: number, standard_error: number):boolean
  ...
  export function spawn_sync(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: SpawnChildSetupFunc, user_data: object, standard_output: number[], standard_error: number[], exit_status: number):boolean
  ...
  export function test_add_vtable(testpath: string, data_size: number, test_data: object, data_setup: TestFixtureFunc, data_test: TestFixtureFunc, data_teardown: TestFixtureFunc):void
  ...
  export function test_create_case(test_name: string, data_size: number, test_data: object, data_setup: TestFixtureFunc, data_test: TestFixtureFunc, data_teardown: TestFixtureFunc):TestCase
  ...
  export function test_log_set_fatal_handler(log_func: TestLogFatalFunc, user_data: object):void
  ...
  export function timeout_add(interval: number, function_: SourceFunc, data: object):number
  export function timeout_add_full(priority: number, interval: number, function_: SourceFunc, data: object, notify: DestroyNotify):number
  export function timeout_add_seconds(interval: number, function_: SourceFunc, data: object):number
  export function timeout_add_seconds_full(priority: number, interval: number, function_: SourceFunc, data: object, notify: DestroyNotify):number
  ...
  export function try_realloc(mem: object, n_bytes: number):object
  export function try_realloc_n(mem: object, n_blocks: number, n_block_bytes: number):object
  ...
  export function unix_fd_add(fd: number, condition: IOCondition, function_: UnixFDSourceFunc, user_data: object):number
  ...
  export function unix_signal_add(signum: number, handler: SourceFunc, user_data: object):number
