...
declare module "Gtk" {
  ...
  export class AccelLabel extends Label {
    ...
    export class LockButton extends Button {
      ...
      get_permission():any
      set_permission(permission: any):void
    }
    ...
    // export class NumerableIcon extends any {
    ...
    export class Style extends GObject.Object {
      ...
      get_style_property(widget_type: number, property_name: string, value: any):void
    ...
    export class TreeModelFilter extends GObject.Object {
      ...
      get_model():any
      refilter():void
      set_modify_func(n_columns: number, types: number[], func: any, data: any, destroy: any):void
