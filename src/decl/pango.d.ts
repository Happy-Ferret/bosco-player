...
declare module "Pango" {
    ...
    export function _break(text: string, length: number, any: any, attrs: any[], attrs_len: number):void
    export function config_key_get(key: string):string
    export function config_key_get_system(key: string):string
    export function default_break(text: string, length: number, any: any, attrs: any, attrs_len: number):void
    ...
    export function find_map(any: any, engine_type_id: number, render_type_id: number):any
    ...
    export function get_log_attrs(text: string, length: number, level: number, any: any, log_attrs: any[], attrs_len: number):void
    export function get_mirror_char(ch: number, mirrored_ch: number):boolean
    export function get_sysconf_subdirectory():string
    export function gravity_get_for_any(any: any):Gravity
    ...
    export function any_from_string(any: string):any
    export function any_get_default():any
    ...
    export function script_get_sample_any(script: Script):any
    export function shape(text: string, length: number, any: any, glyphs: any):void
    export function shape_full(item_text: string, item_length: number, paragraph_text: string, paragraph_length: number, any: any, glyphs: any):void
    ...
    export class Font extends GObject.Object {
        ...
        find_shaper(any: any, ch: number):EngineShape
        get_coverage(any: any):any
        get_font_map():FontMap
        get_glyph_extents(glyph: any, ink_rect: any, logical_rect: any):void
        get_metrics(any: any):any
    }
    ...
    export class FontMap extends GObject.Object {
        ...
        load_fontset(context: Context, desc: any, any: any):Fontset
    }
    ...
    export class Renderer extends GObject.Object {
        ...
        draw_any(part: RenderPart, x: number, y: number, width: number, height: number):void
